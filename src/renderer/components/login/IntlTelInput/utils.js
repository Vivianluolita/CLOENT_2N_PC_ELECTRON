...
;(function () {
  ...
  var ba = m[m.length - 1],
    ...
    t =
      ...
      function (a) {
        ...
        b = this + ''
        if (a < 0 || a > 1342177279) throw new RangeError('Invalid count value')
        a |= 0
        for (var c = ''; a;) if ((a & 1 && (c += b), (a >>>= 1))) b += b
        return c
      }
  t != r && t != null && aa(l, ba, { configurable: !0, writable: !0, value: t })
  var ca = this
  function u (a) {
  ...
  var x = Array.prototype.indexOf
    ...
    : function (a, b, c) {
      ...
      if (u(a)) return u(b) && b.length == 1 ? a.indexOf(b, c) : -1
  ...
  function H (a, b) {
    var c = [],
      d
    for (d in b) d != 0 && c.push(new fa(d, b[d]))
    return new na(a, c)
  }
  function I () {}
  ...
  I.prototype.a = function (a, b) {
    ...
    if (c === String) {
      ...
      c === Number &&
      u(b) &&
      (b === 'Infinity' || b === '-Infinity' || b === 'NaN' || qa.test(b))
    ) {
      return Number(b)
    }
    return b
  ...
  ra.prototype.a = function (a, b) {
    return a.b == 8 ? !!b : I.prototype.a.apply(this, arguments)
  }
  function K (a, b) {
...
*/
  ...
  function Oa (a) {
    return !!a && (G(a, 9) != 1 || D(a, 9)[0] != -1)
  }
  function Ma (a, b) {
    for (var c = new K(), d, e = a.length, f = 0; f < e; ++f) {
      ;(d = a.charAt(f)), (d = b[d.toUpperCase()]), d != null && c.a(d)
    }
    return c.toString()
  }
  function Pa (a) {
    return a != null && isNaN(a) && a.toUpperCase() in xa
  }
  function Qa (a, b, c) {
    if (B(b, 2) == 0 && b.a[5] != null) {
      var d = F(b, 5)
      if (d.length > 0) return d
    }
    var d = F(b, 1),
      e = T(b)
    if (c == 0) return Ra(d, 0, e, '')
    if (!(d in P)) return e
    a = U(a, d, Sa(d))
    b =
      b.a[3] != null && B(b, 3).length
        ? c == 3
          ? ';ext=' + B(b, 3)
          : a.a[13] != null
            ? B(a, 13) + F(b, 3)
        ...
        : ''
    a: {
      a = D(a, 20).length && c != 2 ? D(a, 20) : D(a, 19)
  ...
  function U (a, b, c) {
    return c == '001' ? V(a, '' + b) : V(a, c)
  }
  function T (a) {
    if (a.a[2] == null) return ''
    var b = '' + B(a, 2)
    return a.a[4] != null && B(a, 4) && F(a, 8) > 0
  ...
  function X (a, b) {
    var c = a.length
    return G(b, 9) > 0 && x(D(b, 9), c) == -1 ? !1 : S(F(b, 2), a)
  }
  function Ua (a, b) {
    if (!b) return null
    var c = F(b, 1)
  ...
  function Va (a, b, c, d, e, f) {
    ...
    if (h.length) {
      if (R.test(h)) (h = h.replace(R, '')), (b.b = ''), b.a(La(h)), (g = 1)
        ...
        if (g.search(h)) g = !1
          ...
          k && k[1] != null && k[1].length > 0 && Ma(k[1], ya) == '0'
            ? (g = !1)
    ...
    e && C(f, 6, g)
    if (g != 20) {
      if (b.b.length <= 2) throw Error('Phone number too short after IDD')
      a: {
        a = b.toString()
        if (a.length && a.charAt(0) != '0') {
    ...
    if (
      ...
      !k.lastIndexOf(h, 0) &&
        ...
        Wa(h, c, null),
        (h = h.toString()),
        (!S(k, b.toString()) && S(k, h)) || Y(a, b.toString(), c, -1) == 3))
    ) {
    ...
    if (e && f != null && f.length) {
      ...
      if ((e = g.exec(d))) {
        var f = new RegExp(F(B(b, 1), 2)),
          ...
          k = e.length - 1
        b = B(b, 16)
        if (b != null && b.length && e[k] != null && e[k].length) {
          if (((d = d.replace(g, b)), !h || S(f, d))) {
            c && k > 0 && c.a(e[1]), a.set(d)
          }
        } else if (!h || S(f, d.substring(e[0].length))) {
          c && k > 0 && e[k] != null && c.a(e[1]),
  ...
  function Xa (a, b, c, d) {
    ...
    if (f >= 0) {
      ...
      if (b.charAt(g) == '+') {
        var h = b.indexOf(';', g)
        h > 0 ? e.a(b.substring(g, h)) : e.a(b.substring(g))
      }
      g = b.indexOf('tel:')
      e.a(b.substring(g >= 0 ? g + 4 : 0, f))
    } else e.a(Ja(b))
    f = e.toString()
    g = f.indexOf(';isub=')
    g > 0 && ((e.b = ''), e.a(f.substring(0, g)))
    if (!Ka(e.toString())) {
      throw Error('The string supplied did not seem to be a phone number')
    }
    f = e.toString()
    if (!(Pa(c) || (f != null && f.length > 0 && R.test(f)))) {
      throw Error('Invalid country calling code')
    }
    f = new O()
    d && C(f, 5, b)
    a: {
      b = e.toString()
      g = b.search(Ga)
      if (g >= 0 && Ka(b.substring(0, g))) {
        for (var h = b.match(Ga), k = h.length, q = 1; q < k; ++q) {
          if (h[q] != null && h[q].length > 0) {
            e.b = ''
            e.a(b.substring(0, g))
            b = h[q]
            break a
    ...
    try {
      ...
      if (z.message == 'Invalid country calling code' && R.test(k)) {
    ...
    b &&
      ...
      (e = new K(g.toString())),
      Wa(e, b, c),
      Y(a, e.toString(), b, -1) != 2 &&
        ((g = e), d && c.toString().length > 0 && C(f, 7, c.toString())))
    a = g.toString()
    d = a.length
    if (d < 2) {
      throw Error('The string supplied is too short to be a phone number')
    ...
    if (a.length > 1 && a.charAt(0) == '0') {
      C(f, 4, !0)
      for (d = 1; d < a.length - 1 && a.charAt(d) == '0';) d++
      d != 1 && C(f, 8, d)
    }
    C(f, 2, parseInt(a, 10))
    return f
  ...
  function S (a, b) {
    var c = typeof a === 'string' ? b.match('^(?:' + a + ')$') : b.match(a)
  ...
  v('intlTelInputUtils.formatNumber', function (a, b, c) {
    try {
      var d = Q.a(),
        e = Z(d, a, b)
      return Qa(d, e, typeof c === 'undefined' ? 0 : c)
    } catch (f) {
      return a
    }
  })
  ...
  v('intlTelInputUtils.getValidationError', function (a, b) {
    try {
      ...
      return k.message == 'Invalid country calling code'
        ? 1
        : k.message == 'The string supplied did not seem to be a phone number'
          ? 4
          : k.message == 'Phone number too short after IDD' ||
          k == 'The string supplied is too short to be a phone number'
            ? 2
            : k.message == 'The string supplied is too long to be a phone number'
              ? 3
              : -99
    }
  })
